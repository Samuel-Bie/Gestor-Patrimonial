            ...
            <v-flex xs12 sm6 offset-sm3 md4 offset-md4>
                <v-form
                  ...
                  lazy-validation>
                    ...
                    <v-btn :disabled="!valid||getLoading" type="submit" :loading='getLoading' color="success" @click="validate">
                      Entrar
                    </v-btn>
                </v-form>
            </v-flex>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapGetters(['authUser','getLoading','authUserfailded','authUserSuccess'])
    },
    methods: {
      validate () {
