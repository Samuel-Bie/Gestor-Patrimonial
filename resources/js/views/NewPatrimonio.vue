                ...
                <v-layout row wrap>
                    ...
                    <v-flex xs12 v-if="active_sessao1">
                        <div class="px-0">
                            <patrimonio-new-form-sessao1
                                ...
                                :dados="inicialData"></patrimonio-new-form-sessao1>
                        </div>
                    </v-flex>
                    ...
                    <v-flex xs12 v-if="active_sessao2">
                        <div class="px-0">
                            <patrimonio-new-form-sessao2
                                ...
                                v-on:validado="goto3"
                                v-on:back="goto1"></patrimonio-new-form-sessao2>
                        </div>
                    </v-flex>
                    ...
                    <v-flex xs12 v-if="active_sessao3">
                        <div class="px-0">
                            ...
                            v-on:back="goto2"></patrimonio-new-form-sessao3>
                        </div>
                    </v-flex>
                    ...
                    <v-flex xs12 v-if="active_sessao4">
                        <div class="px-0">
                            ...
                            v-on:validado="enviar" v-on:back="goto3"></patrimonio-new-form-sessao-fotos>
                        </div>
                    </v-flex>
                </v-layout>
            </v-container>
